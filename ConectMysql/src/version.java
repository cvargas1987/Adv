...
public class version {
	...
	public String consultarVersion () throws IOException {
		String version = "Version Actual: 1.0.0.15"; 
...
//		System.out.println("V. 1.0.0.9: Corrige bug");
		...
		System.out.println("V. 1.0.0.13: crea texto con contenido <sin datos> para cuando no halla datos..");
		System.out.println("V. 1.0.0.14: Corrige bug en registro I, agrega el campo Precio.");
		System.out.println("V. 1.0.0.15: Se implementan procedimientos de almacenado.");
		return version;
	}
}
